    ...
    <Layout>
      <div className="min-h-[calc((100vh-7rem))] w-full flex mx-auto flex-col justify-center md:max-w-screen-2xl md:py-5 px-10 item my-10">
        ...
        <p className="mt-3">
          ...
          personne qui accède, utilise ou consulte le site immo-sur.fr. Les
          termes &quot;nous&quot;, &quot;notre&quot; et &quot;immo-sur.fr&quot;
          désignent le propriétaire et exploitant du site.
        </p>
        <h2 className="mt-5">
        ...
        <p className="mt-3">
          ...
          de l&apos;accord entre l&apos;utilisateur et immo-sûr.fr en ce qui
        ...
        <p className="mt-3">
          ...
          d&apos;immo-sûr.fr sera soumis au droit français.
        </p>
        <p className="mt-3">
        ...
        <p className="mt-3">
          9.1. Immo-sûr.fr s&apos;engage à protéger les données personnelles de
          ses utilisateurs conformément à la réglementation applicable en
          matière de protection des données personnelles, notamment le Règlement
          Général sur la Protection des Données (RGPD).
        </p>
        <p className="mt-3">
          9.2. Immo-sûr.fr ne collecte que les données nécessaires à
