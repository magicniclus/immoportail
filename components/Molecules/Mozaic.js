...
const Mozaic = () => {
  return (
    <div
      style={{
        background:
          "radial-gradient(circle, rgba(54,38,118,0.16992734593837533) 0%, rgba(255,255,255,0) 20%)",
      }}
      className="h-5/6 min-w-full flex flex-col "
    >
