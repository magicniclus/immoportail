...
const navigation = {
  solutions: [
    { name: "Estimation", href: "/" },
    { name: "Mon espace", href: "/connexion" },
    { name: "Favoris", href: "/favoris" },
  ],
  support: [{ name: "Contact", href: "nous-contacter" }],
  company: [
    { name: "À props", href: "/" },
    { name: "Blog", href: "/" },
  ],
  legal: [
    ...
    { name: "Conditions d'utilisation", href: "/condition-d-utilisation" },
  ],
  social: [
    {
      name: "Facebook",
  ...
  return (
    <footer className="bg-gray-300" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold leading-6 text-purple">
                  Solutions
                </h3>
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.solutions.map((item) => (
                    <li key={item.name}>
                      <a
                        href={item.href}
                        className="text-sm leading-6 text-gray-600 hover:text-purple"
                      >
                        {item.name}
                      </a>
                    </li>
            ...
            <form onSubmit={handleSubmit} className="mt-6 sm:flex sm:max-w-md">
              ...
              <div className="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                <button
                  disabled={disabled}
                  type="submit"
                  className="flex w-full bg-purple items-center justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-purple focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple"
                >
                  S'inscrire
                </button>
              </div>
        ...
        <div className="mt-16 border-t border-purple/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">
            &copy; 2023 Avenue-immo.com, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
