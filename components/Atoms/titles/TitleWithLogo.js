...
const TitleWithLogo = (props) => {
    ...
    const classDesign = {
        white:"text-white text-2xl md:text-2xl font-bold md:w-10/12 lg:mb-0 " + marginX + " " + marginY,
        purple:"text-purple text-2xl md:text-2xl font-bold md:w-10/12 lg:mb-0 " + marginX + " " + marginY
    }

    return (
        <div className='flex items-center'>
            <div className={"h-4 w-6 lg:mb-0 " + marginX + " " + marginY}>
                <Image src={"/vector/"+image+".png"} height={80} width={80} alt="icon"/>
            </div>
            {
